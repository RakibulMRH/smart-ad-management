...
var email_util_1 = require("../utils/email.util"); // Import the sendResetPasswordEmail function from the appropriate module
var email_util_2 = require("../utils/email.util"); // Import the generateResetToken function from the appropriate module
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (email, password, type) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.usersService.create({ email: email, password: hashedPassword, type: type })];
                        case 2:
                            user = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 5, , 6]);
                            resetToken = (0, email_util_2.generateResetToken)();
                            return [4 /*yield*/, (0, email_util_1.sendResetPasswordEmail)(email, resetToken)];
                        case 3:
                            _a.sent();
                            // Update user's reset token in the database
                            return [4 /*yield*/, this.usersService.updateResetPasswordToken(user.id, resetToken, new Date(Date.now() + 3600000))];
                        case 4:
                            // Update user's reset token in the database
                            _a.sent();
                        ...
                        case 5:
                            error_1 = _a.sent();
                            return [2 /*return*/, { message: 'Failed to send reset password email', error: error_1 }];
