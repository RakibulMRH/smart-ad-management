    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.updateResetPasswordToken = function (userId, resetToken, resetPasswordExpires) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersRepository.update(userId, { resetPasswordToken: resetToken, resetPasswordExpires: resetPasswordExpires })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        UsersService_1.prototype.findByResetPasswordToken = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersRepository.findOne({ where: { resetPasswordToken: token } })];
                });
            });
        };
        UsersService_1.prototype.resetPassword = function (userId, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersRepository.update(userId, { password: newPassword, resetPasswordToken: null, resetPasswordExpires: null })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
